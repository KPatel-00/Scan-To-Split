...
export function BillInfoHeader({ calculatedTotal, itemCount }: BillInfoHeaderProps) {
  ...
  return (
    <motion.div variants={fadeInUp}>
      <Card className="overflow-hidden border-x border-t border-border/40 border-b-0 bg-gradient-to-br from-primary/5 via-card/50 to-primary/10 p-6 pb-4 shadow-sm backdrop-blur-sm transition-all duration-300 hover:shadow-md hover:bg-gradient-to-br hover:from-primary/10 hover:via-card/60 hover:to-primary/15 cursor-pointer">
